...
Route::post('articles/{id}/update', [ArticleController::class, 'update'])->name('update_article');
Route::post('articles/{id}/delete', [ArticleController::class, 'delete'])->name('delete_article');
