            ...
            <nav class="w-full h-max">
                <div class="flex flex-row items-center space-x-96">
                    ...
                    <div class="flex flex-row items-center text-right space-x-20">
                        <p class="text-xl md:text-3xl font-bold text-sky-900 underline">
                            <a href="{{ route('index') }}">Inicio</a>
                        </p>
                        <p class="text-xl md:text-3xl font-bold text-sky-900">
                            <a href="{{ route('novedades') }}">Novedades</a>
                        </p>
                        <p data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" class="text-xl md:text-3xl font-bold text-sky-900 cursor-pointer">
                            Iniciar sesión
                        </p>
                    </div>
                </div>
            ...
            <main>
                <section class="w-full h-max">
                    <div class="flex flex-col items-start mt-20">
                        ...
                        <p class="text-xl text-sky-900 mt-4">
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        ...
                        {{-- <button data-modal-hide="gestion-categorias-modal" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Cerrar</button> --}}
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-slate-100 rounded-lg shadow dark:bg-gray-700 border border-black">
                    ...
                    <form method="POST" action="{{route('create_category')}}">
                        @csrf
                        <div class="p-6 space-y-6">
                            <input type="text" name="name" placeholder="Ej: Entrevista, ensayo..." />
                        </div>
                        <!-- Modal footer -->
                        <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form method="POST" action="{{ route('create_article') }}">
                        ...
                        <div class="flex flex-col p-6 space-y-6">
                            <input type="text" name="title" placeholder="Título del artículo" maxlength="50" />
                        ...
                        <!-- Modal footer -->
                        <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button data-modal-hide="publicar-articulo" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">I accept</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        for (let i = 0; i < categories.length; i++) {
                            ...
                            $('#listed-categories').append(
                                "<div class='grid grid-cols-2'>" +
                                    "<form method='POST' action='"+editRoute+"' class='grid grid-cols-2'>" + 
                                        '<input type="hidden" name="_token" value="{{ csrf_token() }}" />' +
                                        "<div>" +
                                            "<input type='text' name='name' class='w-24' value='"+category['name']+"'>" +
                                        "</div>" +
                                        "<div>" +
